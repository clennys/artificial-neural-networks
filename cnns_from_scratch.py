...
train_dataset = torchvision.datasets.CIFAR10(root = './downloads',
                                             train = True,
                                             transform = all_transforms,
                                             download = True)

# Create Testing dataset
test_dataset = torchvision.datasets.CIFAR10(root = './downloads',
                                            train = False,
                                            transform = all_transforms,
                                            download=True)
...
# Save the whole model (easy way, but not recommended)
